...
|API|描述|
|---|--|
|[DescribeFabricConsortiumConfig](cn.zh-CN/API参考/Hyperledger Fabric/DescribeFabricConsortiumConfig.md)|调用DescribeFabricConsortiumConfig获取“创建联盟”的参数可选值。|
|[DescribeFabricConsortiumSpecs](cn.zh-CN/API参考/Hyperledger Fabric/DescribeFabricConsortiumSpecs.md)|调用DescribeFabricConsortiumSpecs查询联盟的规格列表。|
|[DescribeFabricEcosphereSpecs](cn.zh-CN/API参考/Hyperledger Fabric/DescribeFabricEcosphereSpecs.md)|调用DescribeFabricEcosphereSpecs查询快速模式的规格列表。|
|[DescribeFabricConsortiumOrderers](cn.zh-CN/API参考/Hyperledger Fabric/DescribeFabricConsortiumOrderers.md)|调用DescribeFabricConsortiumOrderers获取联盟的Orderer列表。|
|[AcceptFabricInvitation](cn.zh-CN/API参考/Hyperledger Fabric/AcceptFabricInvitation.md)|调用AcceptFabricInvitation接受加入联盟的邀请。|
|[JoinFabricChannel](cn.zh-CN/API参考/Hyperledger Fabric/JoinFabricChannel.md)|调用JoinFabricChannel确认加入通道。|
|[DescribeFabricInviter](cn.zh-CN/API参考/Hyperledger Fabric/DescribeFabricInviter.md)|调用DescribeFabricInviter获取邀请人信息。|
|[DescribeFabricChannelMembers](cn.zh-CN/API参考/Hyperledger Fabric/DescribeFabricChannelMembers.md)|调用DescribeFabricChannelMembers查询通道的成员列表。|
|[CreateFabricChaincode](cn.zh-CN/API参考/Hyperledger Fabric/CreateFabricChaincode.md)|调用CreateFabricChaincode创建链码。|
|[DescribeFabricOrganizations](cn.zh-CN/API参考/Hyperledger Fabric/DescribeFabricOrganizations.md)|调用DescribeFabricOrganizations获取组织列表。|
|[DescribeFabricCandidateOrganizations](cn.zh-CN/API参考/Hyperledger Fabric/DescribeFabricCandidateOrganizations.md)|调用DescribeFabricCandidateOrganizations查询接收邀请的候选组织。|
|[DescribeFabricChaincodeUploadPolicy](cn.zh-CN/API参考/Hyperledger Fabric/DescribeFabricChaincodeUploadPolicy.md)|调用DescribeFabricChaincodeUploadPolicy获取上传链码策略。|
|[ConfirmFabricConsortiumMember](cn.zh-CN/API参考/Hyperledger Fabric/ConfirmFabricConsortiumMember.md)|调用ConfirmFabricConsortiumMember确认联盟成员的加入申请，需要确认提案。|
|[DescribeFabricOrganizationChaincodes](cn.zh-CN/API参考/Hyperledger Fabric/DescribeFabricOrganizationChaincodes.md)|调用DescribeFabricOrganizationChaincodes获取组织的链码列表。|
|[DescribeFabricConsortiumMembers](cn.zh-CN/API参考/Hyperledger Fabric/DescribeFabricConsortiumMembers.md)|调用DescribeFabricConsortiumMembers获取联盟的组织信息。|
|[DescribeFabricConsortiumAdminStatus](cn.zh-CN/API参考/Hyperledger Fabric/DescribeFabricConsortiumAdminStatus.md)|调用DescribeFabricConsortiumAdminStatus获取联盟管理状态信息。|
|[InstallFabricChaincode](cn.zh-CN/API参考/Hyperledger Fabric/InstallFabricChaincode.md)|调用InstallFabricChaincode安装链码。|
|[CheckFabricConsortiumDomain](cn.zh-CN/API参考/Hyperledger Fabric/CheckFabricConsortiumDomain.md)|调用CheckFabricConsortiumDomain检查联盟域名是否可用。|
|[DescribeFabricOrganizationPeers](cn.zh-CN/API参考/Hyperledger Fabric/DescribeFabricOrganizationPeers.md)|调用DescribeFabricOrganizationPeers获取组织的节点列表。|
|[DescribeFabricConsortiumMemberApproval](cn.zh-CN/API参考/Hyperledger Fabric/DescribeFabricConsortiumMemberApproval.md)|调用DescribeFabricConsortiumMemberApproval获取联盟成员的审批状态列表。|
|[SynchronizeFabricChaincode](cn.zh-CN/API参考/Hyperledger Fabric/SynchronizeFabricChaincode.md)|调用SynchronizeFabricChaincode同步链码的升级和实例化的状态。|
|[DescribeFabricOrganizationDeletable](cn.zh-CN/API参考/Hyperledger Fabric/DescribeFabricOrganizationDeletable.md)|调用DescribeFabricOrganizationDeletable查询组织是否可删除。|
|[DescribeFabricOrganizationChannels](cn.zh-CN/API参考/Hyperledger Fabric/DescribeFabricOrganizationChannels.md)|调用DescribeFabricOrganizationChannels获取该组织加入的通道列表。|
|[DescribeFabricConsortiums](cn.zh-CN/API参考/Hyperledger Fabric/DescribeFabricConsortiums.md)|调用DescribeFabricConsortiums获取联盟列表。|
|[DescribeFabricConsortiumDeletable](cn.zh-CN/API参考/Hyperledger Fabric/DescribeFabricConsortiumDeletable.md)|调用DescribeFabricConsortiumDeletable查询联盟是否可删除。|
|[CreateFabricChannelMember](cn.zh-CN/API参考/Hyperledger Fabric/CreateFabricChannelMember.md)|调用CreateFabricChannelMember将其他组织添加到通道中。|
|[CreateFabricConsortiumMember](cn.zh-CN/API参考/Hyperledger Fabric/CreateFabricConsortiumMember.md)|调用CreateFabricConsortiumMember创建一个组织加入联盟的提案。|
|[DescribeFabricConsortiumChaincodes](cn.zh-CN/API参考/Hyperledger Fabric/DescribeFabricConsortiumChaincodes.md)|调用DescribeFabricConsortiumChaincodes获取联盟的链码列表。|
|[DeleteFabricChaincode](cn.zh-CN/API参考/Hyperledger Fabric/DeleteFabricChaincode.md)|调用DeleteFabricChaincode删除错误的链码。|
|[DownloadFabricOrganizationSDK](cn.zh-CN/API参考/Hyperledger Fabric/DownloadFabricOrganizationSDK.md)|调用DownloadFabricOrganizationSDK下载SDK。|
|[ResetFabricOrganizationUserPassword](cn.zh-CN/API参考/Hyperledger Fabric/ResetFabricOrganizationUserPassword.md)|调用ResetFabricOrganizationUserPassword重置用户密码。|
